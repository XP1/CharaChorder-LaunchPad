...
Charachorder Launchpad is a training tool for Charachorder users. It allows these users to practicing their typing, trigrams, and chording. It is a essentially a web port of the application found here: https://www.charachorder.com/.
...
For more information, see the articles on architecture, testing, and deployment [on the Wiki].
