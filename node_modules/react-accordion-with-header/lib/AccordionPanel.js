...
var AccordionPanel = function (_PureComponent) {
  ...
  function AccordionPanel() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.state = {
      ...
      var panelHeight = _react.Children.map(_this.props.children, function (child, i) {
      ...
      var wrapComponent = function wrapComponent(components) {
        return _react.Children.map(components, function (child, index) {
          ...
          return _react2.default.createElement(WrappedComponent, { ref: ref });
        });
      };
      ...
      if (_this.props.template) {
        ...
        return wrapComponent((0, _react.cloneElement)(_this.props.template));
      }
